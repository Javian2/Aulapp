...
@Component({
  selector: 'app-crud-valoraciones',
  templateUrl: './crud-valoraciones.component.html',
  styleUrls: ['./crud-valoraciones.component.css']
})
export class CrudValoracionesComponent implements OnInit {
...
if(!this.filterReserva){
        this._valoraciones.borrarValoraciones(id)
        .subscribe((data:any) => {
  ...
  cargarValoraciones(){
    this._valoraciones.getValoracionesPaginada(this.desde).subscribe((data:any) => {
          this.reservavar = data;
        });
    this._valoraciones.getValoracionesTotal().subscribe((data:any) =>{
  ...
  buscarReserva(texto:string){
    ...
    if(texto){ 
      this._valoraciones.getValoracionesPorID(texto).subscribe((data: any[]) =>{
